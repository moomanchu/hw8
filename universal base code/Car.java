...
public class Car{
	...
	public void Drive(int speed, int time){
		...
		if(l1.getX()>625){
			body1.translate(-625,100);
			body2.translate(-625,100);
			w1.translate(-625,100);
			w2.translate(-625,100);
			front.translate(-625,100);
			l1.translate(-625,100);
			l2.translate(-625,100);
			l3.translate(-625,100);
			l4.translate(-625,100);
			label.translate(-625,100);
		}
		if(l1.getY()>519){
	...
	public void draw(){
		...
		roady = 1;
		for(int z = 0; z<6; z++){
			road = new Line(0,roady,625,roady);
			road.draw();
			roady = roady+100;
		}
		//draws roads
